...
INSERT INTO `tbl_books` (`bid`, `title`, `author`, `genre`, `description`, `publisher`, `published_year`, `language`, `isbn`, `page_count`, `cover_image`, `tags`, `book_file`) VALUES
...
(5, 'Lorem', 'John', 'Lorem', 'sdaadasdda', 'AG International', '2025', 'English', '5454564', 22, '/uploads/1757321046488-image-0-1653918564.webp', 'sd,sdfs,fowe', '/uploads/1757321046490-file-sample_150kB.pdf');
...
INSERT INTO `tbl_downloads` (`did`, `uid`, `bid`, `times`) VALUES
(1, 8, 5, '2');
...
CREATE TABLE `tbl_users` (
  ...
  `genre_like` varchar(150) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tbl_users` (`uid`, `uname`, `uemail`, `umobile`, `upass`, `genre_like`) VALUES
...
(7, 'Sam', 'sam@gmail.com', '7896541230', '123', '[\"animi\",\"history\"]'),
(8, 'Ram', 'ram14@gmail.com', '9632014578', '123', '[\"Lorem\",\"romantic\",\"animi\"]');
...
--
ALTER TABLE `tbl_downloads`
  ADD CONSTRAINT `tbl_downloads_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `tbl_users` (`uid`),
  ADD CONSTRAINT `tbl_downloads_ibfk_2` FOREIGN KEY (`bid`) REFERENCES `tbl_books` (`bid`);

--
-- Constraints for table `tbl_user_activity`
--
ALTER TABLE `tbl_user_activity`
  ADD CONSTRAINT `tbl_user_activity_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `tbl_users` (`uid`),
  ADD CONSTRAINT `tbl_user_activity_ibfk_2` FOREIGN KEY (`bid`) REFERENCES `tbl_books` (`bid`);
COMMIT;
